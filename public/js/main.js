...
try {
	...
	fetch("http://localhost:3000/acti", {
		 ...
		 if (!r.information) {
			 ...
			 $(".activity").html(`
					<div class="list-activity">
						<img width="70" style="border-radius: 6px;"src="https://i.scdn.co/image/${r.information.assets.largeImage.substr(8)}">
						<div style="line-height: 0.8;" class="list-a-texts">
							<h4 style="font-size: 1rem; text-align: left;"><img style="width: 15px;" src="https://open.spotifycdn.com/cdn/images/equaliser-animated-green.f5eb96f2.gif"> <color style="color: #1db954;">${r.information.details}</color></h4>
